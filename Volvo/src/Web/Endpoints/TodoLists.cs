...
using Volvo.Application.TodoLists.Commands.DeleteTodoList;
using Volvo.Application.TodoLists.Commands.UpdateTodoList;
using Volvo.Application.TodoLists.Queries.GetTodos;
using Microsoft.AspNetCore.Http.HttpResults;

namespace Volvo.Web.Endpoints;
